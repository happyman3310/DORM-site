    ...
    <div className="space-y-8">
      ...
      <GlassCard>
        <div className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-muted">
              <p className="text-xs uppercase tracking-[0.2em] text-muted">Итог</p>
              <p className="mt-3 text-sm text-app">Выбор частично совпал с ожиданиями.</p>
              <p className="mt-2">Главный разрыв — энергия и сложность, требуется корректировка ритма.</p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-muted">
              <p className="text-xs uppercase tracking-[0.2em] text-muted">Решение</p>
              <div className="mt-3 space-y-2 text-sm text-muted">
                <p>• Продолжить ещё 2 недели.</p>
                <p>• Снизить нагрузку на 20%.</p>
                <p>• Повторная проверка в октябре.</p>
              </div>
            </div>
          </div>
