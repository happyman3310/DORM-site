...
import { planLimits } from '../config/wayn';
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <GlassCard className="space-y-4">
          ...
          <ul className="space-y-2 text-sm text-muted">
            <li>• До {planLimits.free.activeDirections} активных выборов</li>
            <li>• История за {planLimits.free.historyDays} дней</li>
        ...
        <GlassCard className="space-y-4 border border-accent/40">
          ...
          <ul className="space-y-2 text-sm text-muted">
            ...
            <li>• История за {Math.round(planLimits.pro.historyDays / 30)} месяцев</li>
      ...
      <GlassCard>
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
            {[
              { label: 'Активные выборы', free: `до ${planLimits.free.activeDirections}`, pro: 'без ограничений' },
              { label: 'История', free: `${planLimits.free.historyDays} дней`, pro: `${Math.round(planLimits.pro.historyDays / 30)} месяцев` },
              { label: 'Сценарии', free: `${planLimits.free.scenarios} путь`, pro: 'несколько' },
            ].map((row) => (
